...
class UNet2D(nn.Module):
  ...
  def __init__(self, n_channels, n_classes):
    ...
    self.down1 = Down(64, 128) # 128 -> 64
    self.down2 = Down(128, 256) # 64 -> 32
    self.down3 = Down(256, 512) # 32 -> 16
    self.down4 = Down(512, 512) # 16 -> 8

    self.bottle_neck  = BottleNeck(in_dim = 8*8*512)
    
    self.up1 = Up(8, 512, 512)
