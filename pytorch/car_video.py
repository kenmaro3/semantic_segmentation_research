...
class Car(Dataset):
    def __init__(self, paths_data, paths_label, obj_data, obj_label, frames, batch_size=16) -> None:
        super().__init__()
...
if __name__ == '__main__':
    ...
    dataset = Car(paths_data,paths_label,video_obj_data,video_obj_label,train_frames, batch_size=4)
