...
from dl_normal import DataLoader
...
checkpoint = ModelCheckpoint("/home/ubuntu/workdir/mihara/MODEL_2d/model_224.h5",
                             verbose=1,
                             save_freq='epoch',
                             save_best_only=True,
...
plt.legend()
plt.show()
fig.savefig("/home/ubuntu/workdir/mihara/MODEL_2d/model_224.jpg", transparent=True)
